...
export function DriverForgotPasswordScreen({ onOtpVerified, onLoginPress, onSignUpPress }: Props) {
        ...
        >
          ...
          <View style={styles.field}>
            ...
            <TextInput
              ...
              placeholder="thabo.driver@email.com"
              value={email}
              onChangeText={(text) => {
                setEmail(text);
                setOtpSent(false);
